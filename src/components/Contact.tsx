      ...
      <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        >
          ...
          <div className="flex gap-4 w-full sm:w-auto justify-center">
            <a href="https://desync.wtf" target="_blank" rel="noopener noreferrer" className="p-4 glass-button rounded-xl text-white/70 hover:text-white transition-all cursor-pointer" aria-label="Website">
              <Globe className="w-6 h-6" />
            </a>
            <a href="https://t.me/mightbeneptune" target="_blank" rel="noopener noreferrer" className="p-4 glass-button rounded-xl text-white/70 hover:text-white transition-all cursor-pointer" aria-label="Telegram">
